...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { address: @education.address, latitude: @education.latitude, longitude: @education.longitude, site: @education.site }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { address: @education.address, latitude: @education.latitude, longitude: @education.longitude, site: @education.site }
    assert_redirected_to education_path(assigns(:education))
  end
